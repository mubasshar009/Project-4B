...
const Header = () => {
    return (
        <div className="flex  bg-green-800 items-center justify-around align-middle h-40 ">
            <div className="flex  cursor-pointer">
                <img className=" h-48 mt-4  w-48" src={logo} alt="brandLogo" />
            </div>
            {/* Middle */}
            <div className="hidden md:flex text-white text-md font-semibold space-x-7  ">
            ...
            {/* Right */}
            <div className="hidden md:flex hover-eff  justify-around items-center text-white text-md font-semibold space-x-7">
                <div className=" justify-around cursor-pointer animate__animated animate__fadeInRight animate__slower">
                    <h1>ENG </h1>
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                </div>
